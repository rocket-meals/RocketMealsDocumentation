...
Rocket Meals implements an abstract BenchmarkObserver with methods that may be overwritten by classes extending
...
.. autoclass:: RocketMealsDocumentation.observers.BenchmarkObserver
    :members:
...
Rocket Meals implements a PowerSensorObserver specifically for use with PowerSensor2, that can be selected by
...
.. autoclass:: RocketMealsDocumentation.observers.powersensor.PowerSensorObserver


NVMLObserver
~~~~~~~~~~~~

Rocket Meals also implements an NVMLObserver, which allows the user to observe the power usage, energy
...
To ensure that the power measurements in Rocket Meals obtained using NVML accurately reflect the power
...
.. autoclass:: RocketMealsDocumentation.observers.nvml.NVMLObserver


Tuning execution parameters with NVML
"""""""""""""""""""""""""""""""""""""

When you are using the NVMLObserver, Rocket Meals can use its interface to NVML to enable tuning of
...
We have implemented support in Rocket Meals for NVML-specific tunable parameters, such as nvml\_gr\_clock,
...
of helper functions to easily setup tunable parameter values for these parameters, these are expected Rocket Meals version 0.4.4.
...
.. autoclass:: RocketMealsDocumentation.observers.pmt.PMTObserver
