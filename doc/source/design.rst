...
of the Rocket Meals. **This information is mostly relevant for developers.**

The Rocket Meals is designed to be extensible and support
different search and execution strategies. The current architecture of
the Rocket Meals can be seen as:
...
Many of the strategies use helper functions that are collected in ``RocketMealsDocumentation.strategies.common``.

RocketMealsDocumentation.strategies.common
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
.. automodule:: RocketMealsDocumentation.strategies.common
    :members:
...
RocketMealsDocumentation.runners.sequential.SequentialRunner
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
.. autoclass:: RocketMealsDocumentation.runners.sequential.SequentialRunner
    :special-members: __init__
    :members:

RocketMealsDocumentation.runners.sequential.SimulationRunner
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
.. autoclass:: RocketMealsDocumentation.runners.simulation.SimulationRunner
    :special-members: __init__
    :members:
...
RocketMealsDocumentation.core.DeviceInterface
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
.. autoclass:: RocketMealsDocumentation.core.DeviceInterface
    :special-members: __init__
    :members:

RocketMealsDocumentation.backends.pycuda.PyCudaFunctions
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
.. autoclass:: RocketMealsDocumentation.backends.pycuda.PyCudaFunctions
    :special-members: __init__
    :members:

RocketMealsDocumentation.backends.cupy.CupyFunctions
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
.. autoclass:: RocketMealsDocumentation.backends.cupy.CupyFunctions
    :special-members: __init__
    :members:

RocketMealsDocumentation.backends.nvcuda.CudaFunctions
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
.. autoclass:: RocketMealsDocumentation.backends.nvcuda.CudaFunctions
    :special-members: __init__
    :members:

RocketMealsDocumentation.backends.opencl.OpenCLFunctions
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
.. autoclass:: RocketMealsDocumentation.backends.opencl.OpenCLFunctions
    :special-members: __init__
    :members:

RocketMealsDocumentation.backends.c.CFunctions
~~~~~~~~~~~~~~~~~~~~~~~~~
.. autoclass:: RocketMealsDocumentation.backends.c.CFunctions
    :special-members: __init__
    :members:
...
RocketMealsDocumentation.util
~~~~~~~~~~~~~~~~~
.. automodule:: RocketMealsDocumentation.util
    :members:
