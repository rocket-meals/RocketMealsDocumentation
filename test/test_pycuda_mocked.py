...
from RocketMealsDocumentation.backends import pycuda
...
@patch('RocketMealsDocumentation.backends.pycuda.nvml')
@patch('RocketMealsDocumentation.backends.pycuda.DynamicSourceModule')
@patch('RocketMealsDocumentation.backends.pycuda.drv')
