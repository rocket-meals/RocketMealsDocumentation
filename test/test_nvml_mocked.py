...
from RocketMealsDocumentation.observers.nvml import get_nvml_pwr_limits, get_nvml_gr_clocks, get_nvml_mem_clocks, get_idle_power
...
@patch('RocketMealsDocumentation.observers.nvml.nvml')
