...
def create_device_targets(header_filename, results_filename, objective=None, objective_higher_is_better=None):
    ...
    template_header_file = f"""/* header file generated by Rocket Meals, do not modify by hand */
#pragma once
#ifndef RocketMealsDocumentation /* only use these when not tuning */
...
#endif /* RocketMealsDocumentation */
"""
